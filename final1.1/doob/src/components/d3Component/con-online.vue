<template> 
  ...
  <div id="heatmap2" style="text-align: center;"></div>
  </div>
</template>
...
export default {
  ...
  mounted() {
    this.drawHeatmap();
    this.drawHeatmapVoice();
  },
  methods: {
    drawHeatmap() {
      const data = [
  [1, 0.692, 0.293, 0.018, 0.328, 0.093, 0.583],
  [0.692, 1, 0.923, 0.293, 0.128, 0.031, 0.829],
  [0.293, 0.923, 1, 0.281, 0.283, 0.007, 0.628],
  [0.018, 0.293, 0.281, 1, 0.5, 0.129, 0.102],
  [0.328, 0.128, 0.283, 0.5, 1, 0.029, 0.008],
  [0.093, 0.031, 0.007, 0.129, 0.029, 1, -0.001],
  [0.583, 0.829, 0.628, 0.102, 0.008, -0.001, 1],
];
...
const labels = [
  ...
  '客服质量', '消费信息', '用户信息', '终端',
      ...
      const heatmapGroup = svg.append('g')
        ...
        .attr('transform', `translate(${(containerWidth - heatmapWidth) }, ${(containerHeight - heatmapHeight) / 2})`);
